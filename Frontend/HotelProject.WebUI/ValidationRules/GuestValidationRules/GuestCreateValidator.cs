...
namespace HotelProject.WebUI.ValidationRules.GuestValidationRules
{
    public class GuestCreateValidator : AbstractValidator<CreateGuestDto>
    {
        public GuestCreateValidator()
        {
            ...
            RuleFor(x => x.Name).MaximumLength(20).WithMessage("En fazla 20 karakter veri girişi yapabilirsiniz.");
            RuleFor(x => x.Surname).MaximumLength(30).WithMessage("En fazla 30 karakter veri girişi yapabilirsiniz.");
            RuleFor(x => x.City).MaximumLength(20).WithMessage("En fazla 20 karakter veri girişi yapabilirsiniz.");
